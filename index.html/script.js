...
recognition.onresult= function(event){
  ...
  //  readOut(transcript);
   ...
   if(transcript.includes("please active")|| transcript.includes("active") ||transcript.includes("satish")){
    readOut("tell me sir");
   }
  ...
  if(transcript.includes("can I download commands")|| transcript.includes("download command")|| transcript.includes("download commands")){
